...
--------------------------------------------------------------------------------------------------
git branch -a |=> This command List all brance local and Remote
--------------------------------------------------------------------------------------------------
git branch -d [branch name]  |=>This command deletes the feature branch.
--------------------------------------------------------------------------------------------------
git push origin --delete [branch name] |=>Delete a remote branch
--------------------------------------------------------------------------------------------------
git checkout [branch name] |=>This command is used to switch from one branch to anothe
--------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------
git remote add [origin] [Remote Server Link]  |=>This command is used to connect your local repository to the remote server.
---------------------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------
git push [origin] :[branch name] |=>This command deletes a branch on your remote repository.
--------------------------------------------------------------------------------------------------
